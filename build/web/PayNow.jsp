								...
								<!--custom-widgets-->
                                                                                                ...
                                                                                                <div>
                                                                                                    ...
                                                                                                    <table border="2" width="800" cellspacing="0" cellpadding="8">
                                                                                                        <tr>
                                                                                                         ...
                                                                                                         <%
                                                                                                            ...
                                                                                                            try
                                                                                                            {
                                                                                                                ...
                                                                                                                String q1 = "select * from invoice where pid='"+pid+"' and paid is null";
                                                                                                        ...
                                                                                                        <table>
                                                                                                            <tr><td><b>Total Amount :</b> </td><td><input type="text" name="total_amt" value="<%=due_sum%>" readonly/></td></tr>
                                                                                                            <tr><td><b>Payable Amount</b>(Total payment due as per 10% of the Total Invoice Amount) : </td><td><input type="text" name="total_due" value="<%=due_sum*0.1%>" readonly/></td></tr>
                                                                                                            <tr><td></td><td><Input type="submit" value="Pay Now"/></a></td></tr>
                                                                                                        </table>
                                                                                                        </form>
                                                                                                </div>
										<!--//outer-wp-->
