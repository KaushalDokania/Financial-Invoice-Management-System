                                                                                                ...
                                                                                                <div>
                                                                                                    ...
                                                                                                    <table border="2" width="800" cellspacing="0" cellpadding="8">
                                                                                                        <tr>
                                                                                                         ...
                                                                                                         <%
                                                                                                            String inv_no="",item_name="";
                                                                                                            String q1="";
                                                                                                            float amount=0;
                                                                                                            int count = 0,qty=0,price=0,amt=0;
                                                                                                            ResultSet rs;
                                                                                                            ...
                                                                                                            try
                                                                                                            {
                                                                                                                ...
                                                                                                                while(rs.next() )   //both query runs
                                                                                                                {
                                                                                                                    ...
                                                                                                                    String q2 = "select pid,customer_name from invoice where invoice_no='"+inv_no+"'";
                                                                                                                    ResultSet rs2 = stmt2.executeQuery(q2);
                                                                                                                    if(rs2.next())
                                                                                                                    {
                                                                                                                        String id = rs2.getString(1);
                                                                                                                        String cname = rs2.getString(2);
                                                                                                                        String q3 = "select name from partners where id='"+id+"'";
                                                                                                                        ResultSet rs3 = stmt3.executeQuery(q3);
                                                                                                                        if(rs3.next())
                                                                                                                        {
                                                                                                                            String pname = rs3.getString(1);
                                                                                                                            out.print("<tr>"
                                                                                                                                    +"<td>"+count+"</td>"
                                                                                                                                    +"<td>"+inv_no+"</td>"
                                                                                                                                    +"<td>"+id+"</td>"
