                                                                                                    ...
                                                                                                    <div class="container">
                                                                                                        ...
                                                                                                        <div class="row">
                                                                                                                        ...
                                                                                                                        &nbsp;
                                                                                                                            <div id="custom-search-input">
                                                                                                                                <div class="input-group col-md-12">
                                                                                                                                    <input type="text" class="form-control input-lg" placeholder="Search Partner ID" />
                                                                                                                ...
                                                                                                                <div class="row">
                                                                                                                    <div class="col-md-6">
                                                                                                                        &nbsp;
                                                                                                                            <div id="custom-search-input">
                                                                                                                                <div class="input-group col-md-12">
                                                                                                                                    <input type="text" class="form-control input-lg" placeholder="From Invoice#" />
                                                                                                                    ...
                                                                                                                    <div class="col-md-6">
                                                                                                                        &nbsp;
                                                                                                                            <div id="custom-search-input">
                                                                                                                                <div class="input-group col-md-12">
                                                                                                                                    <input type="text" class="form-control input-lg" placeholder="To Invoice#" />
                                                                                                            ...
                                                                                                            <div class="container col-md-6" >
                                                                                                                ...
                                                                                                                <div>
                                                                                                                    <a href="block.jsp"><button type="button" class='btn btn-danger btn-block'>Block Partner</button></a>
                                                                                                                </div>
